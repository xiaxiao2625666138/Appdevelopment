...
@WebServlet(name = "ChooseAllOrderServlet")
public class ChooseAllOrderServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public ChooseAllOrderServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            String sql;
            sql = "SELECT chooseAllOrder(\"" + uname + "\", \""+ chosen+ "\") as statusNum;";
            out.println(sql);
